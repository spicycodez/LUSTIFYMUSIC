...
def first_page(_):
	controll_button = [InlineKeyboardButton(text="◁", callback_data=f"Lustify"), InlineKeyboardButton(text="ʜᴏᴍᴇ", callback_data=f"settingsback_helper"), InlineKeyboardButton(text="▷", callback_data=f"shivXlustify")]
