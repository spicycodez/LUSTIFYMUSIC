...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("LustifyMusic/assets/font.ttf", 32)
        regular_font = ImageFont.truetype("LustifyMusic/assets/font2.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "LustifyMusic/assets/play_icons.png"
