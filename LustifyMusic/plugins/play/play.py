...
EMOJII = [
    ...
    "ᴄᴏᴍᴇ ᴄʟᴏꜱᴇʀ ʙᴀʙʏ, ʟᴇᴛ'ꜱ ᴅᴀɴᴄᴇ ꜱʟᴏᴡ 🦋💫",
    "ʙᴀʙʏ, ꜰᴇᴇʟ ᴛʜᴇ ᴍᴜꜱɪᴄ ᴏɴ ᴜꜱ ✨🥀",
    "ᴄᴀɴ'ᴛ ʀᴇꜱɪꜱᴛ ᴜ ʙᴀʙʏ, ʟᴇᴛ'ꜱ ᴠɪʙᴇ 🦋✨",
    "ʙᴀʙʏ, ᴇᴠᴇʀʏ ʙᴇᴀᴛ ɪꜱ ꜰᴏʀ ᴜ 🥀🦋",
    "ʟᴇᴛ'ꜱ ɢᴇᴛ ɴᴀᴜɢʜᴛʏ ʙᴀʙʏ, ᴍᴜꜱɪᴄ ꜱᴛʏʟᴇ ✨🥀",
    "ʙᴀʙʏ, ᴄᴀɴ ᴜ ꜰᴇᴇʟ ᴍʏ ᴠɪʙᴇ? 🦋✨",
    "ᴏᴏʜ ʙᴀʙʏ, ᴛʜɪꜱ ʙᴇᴀᴛ ɪꜱ ꜱᴏ ꜰᴜɴ 🥀✨",
    "ʙᴀʙʏ, ʟᴇᴛ'ꜱ ᴅɪsᴄᴏᴠᴇʀ ᴛʜɪꜱ ʀʜʏᴛʜᴍ ✨🦋",
    "ʜᴏʟᴅ ᴍᴇ ᴛɪɢʜᴛ ʙᴀʙʏ, ᴡɪʟʟ ᴜ ᴅᴀɴᴄᴇ? 🥀✨",
    "ʙᴀʙʏ, ᴍʏ ʜᴇᴀʀᴛ ʙᴇᴀᴛs ᴡɪᴛʜ ᴛʜɪꜱ ʙᴇᴀᴛ 🦋✨",
    "ʙᴀʙʏ, ʟᴇᴛ'ꜱ ɢᴏ ᴄʟᴏꜱᴇʀ… ᴄᴀɴ ᴜ ꜰᴇᴇʟ ᴍᴇ? 🥀🦋",
    "ᴄᴀɴ'ᴛ ʀᴇꜱɪꜱᴛ ᴛʜɪꜱ ʙᴇᴀᴛ ʙᴀʙʏ ✨🦋",
    "ʙᴀʙʏ, ʟᴇᴛ'ꜱ ᴅɪsᴄᴏᴠᴇʀ ᴛʜɪꜱ ᴍᴏᴍᴇɴᴛ 🥀✨",
    "ʟᴇᴛ'ꜱ ᴅᴀɴᴄᴇ ᴛɪʟʟ ᴡᴇ ꜱᴡᴇᴀᴛ ʙᴀʙʏ 🦋✨",
    "ᴏᴏʜ ʙᴀʙʏ, ᴛʜɪꜱ ʙᴇᴀᴛ ɪꜱ ᴍᴀᴋɪɴɢ ᴍᴇ ᴄʀᴀᴢʏ 🥀🦋",
    "ʙᴀʙʏ, ᴘʟᴀʏ ᴡɪᴛʜ ᴍᴇ ᴛʜɪꜱ ᴍᴜꜱɪᴄ ✨🥀",
    "ʙᴀʙʏ, ʜᴏʟᴅ ᴏɴ ᴛɪɢʜᴛ, ᴄᴀɴ ᴜ ꜰᴇᴇʟ ᴛʜɪꜱ? 🦋✨",
    "ʟᴇᴛ'ꜱ ɢᴏ ʙᴀʙʏ, ᴛʜɪꜱ ʙᴇᴀᴛ ɪꜱ ᴏᴜʀꜱ 🥀🦋",
    "ʙᴀʙʏ, ᴄᴀɴ ᴜ ʜᴇᴀʀ ᴍʏ ʜᴇᴀʀᴛ ʙᴇᴀᴛ? ✨🦋",
    "ᴏᴏʜ ʙᴀʙʏ, ᴛʜɪꜱ ɪꜱ ᴊᴜꜱᴛ ᴛʜᴇ ʙᴇɢɪɴɴɪɴɢ 🥀✨"
]
...
@app.on_callback_query(filters.regex("LustifymousAdmin") & ~BANNED_USERS)
async def Lustifymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(filters.regex("LustifyPlaylists") & ~BANNED_USERS)
@languageCB
